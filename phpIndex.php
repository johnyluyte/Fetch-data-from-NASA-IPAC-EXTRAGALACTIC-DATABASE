...
<body>
    <div class="navbar navbar-default">
      <div class="navbar-collapse collapse navbar-responsive-collapse">
        <ul class="nav navbar-nav">
            <li><a href="ajaxIndex.php">AJAX</a></li>
            <li class="active"><a href="phpIndex.php">PHP Form </a></li>
        </ul>
      </div>
    </div>
    ...
    <div id="div_start">
        ...
        <div class="alert alert-warning" role="alert">
            If the sample number is set too large (i.e. larger than 100), it may take a long time to get the result. To fetch 1000 samples, it is recommended to fetch 100 samples 10 times, which is much faster than fetching 1000 samples directly. Or you can choose the AJAX method from the menu bar.<br>
        </div>
    </div>
    <hr>
